...
import me.gege.trimmersmp.item.custom.GlintingItem;
...
public class ModItems {
    public static final Item HARNESS_CRYSTAL = registerItem("harness_crystal", new GlintingItem(new FabricItemSettings().maxCount(1).fireproof()));
    public static final Item ROOTED_SHARD = registerItem("rooted_shard", new Item(new FabricItemSettings().maxCount(1).fireproof()));
    public static final Item REFINED_SHARD = registerItem("refined_shard", new GlintingItem(new FabricItemSettings().maxCount(1).fireproof()));
